 ...
 */
final class Version20240613212422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9B76551FED7016E0 ON fichier');
        $this->addSql('ALTER TABLE fichier CHANGE facture_id_id facture_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_9B76551F7F2DEE08 ON fichier (facture_id)');
        ...
        $this->addSql('ALTER TABLE ligne_facture CHANGE facture_id facture_id INT NOT NULL');
        $this->addSql('ALTER TABLE ligne_facture ADD CONSTRAINT FK_611F5A297F2DEE08 FOREIGN KEY (facture_id) REFERENCES facture (id)');
        $this->addSql('ALTER TABLE projet CHANGE budget budget NUMERIC(10, 2) DEFAULT NULL, CHANGE responsable_id responsable_id INT DEFAULT NULL, CHANGE statut statut VARCHAR(255) DEFAULT NULL, CHANGE budget_previsionnel budget_previsionnel NUMERIC(10, 2) DEFAULT NULL, CHANGE budget_reel budget_reel NUMERIC(10, 2) DEFAULT NULL, CHANGE avancement avancement INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet CHANGE budget budget NUMERIC(10, 2) NOT NULL, CHANGE responsable_id responsable_id INT NOT NULL, CHANGE statut statut VARCHAR(255) NOT NULL, CHANGE budget_previsionnel budget_previsionnel NUMERIC(10, 2) NOT NULL, CHANGE budget_reel budget_reel NUMERIC(10, 2) NOT NULL, CHANGE avancement avancement INT NOT NULL');
        ...
        $this->addSql('DROP INDEX IDX_9B76551F7F2DEE08 ON fichier');
        $this->addSql('ALTER TABLE fichier CHANGE facture_id facture_id_id INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_9B76551FED7016E0 ON fichier (facture_id_id)');
        $this->addSql('ALTER TABLE ligne_facture DROP FOREIGN KEY FK_611F5A297F2DEE08');
        $this->addSql('ALTER TABLE ligne_facture CHANGE facture_id facture_id INT DEFAULT NULL');
    }
}
