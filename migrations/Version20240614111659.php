 ...
 */
final class Version20240614111659 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet DROP responsable_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet ADD responsable_id INT DEFAULT NULL');
