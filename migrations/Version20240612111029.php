 ...
 */
final class Version20240612111029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jalon ADD projet_id INT NOT NULL');
        $this->addSql('ALTER TABLE jalon ADD CONSTRAINT FK_9F9801E4C18272 FOREIGN KEY (projet_id) REFERENCES projet (id)');
        $this->addSql('CREATE INDEX IDX_9F9801E4C18272 ON jalon (projet_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9F9801E4C18272 ON jalon');
        $this->addSql('ALTER TABLE jalon DROP projet_id');
