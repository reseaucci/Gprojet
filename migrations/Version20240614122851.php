 ...
 */
final class Version20240614122851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet ADD date_debut DATETIME NOT NULL, ADD utilisateur_id INT NOT NULL, DROP responsable_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_50159CA9FB88E14F ON projet');
        $this->addSql('ALTER TABLE projet ADD responsable_id INT DEFAULT NULL, DROP date_debut, DROP utilisateur_id');
