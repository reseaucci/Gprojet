 ...
 */
final class Version20240612134232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE responsable DROP role');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE responsable ADD role VARCHAR(255) NOT NULL');
