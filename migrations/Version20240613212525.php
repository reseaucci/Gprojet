 ...
 */
final class Version20240613212525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE risque DROP propabilite');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE risque ADD propabilite INT NOT NULL');
