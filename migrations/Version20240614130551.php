 ...
 */
final class Version20240614130551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet ADD responsable_id INT NOT NULL, DROP responsable_nom');
        $this->addSql('ALTER TABLE projet ADD CONSTRAINT FK_50159CA953C59D72 FOREIGN KEY (responsable_id) REFERENCES responsable (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet ADD responsable_nom VARCHAR(255) DEFAULT NULL, DROP responsable_id');
